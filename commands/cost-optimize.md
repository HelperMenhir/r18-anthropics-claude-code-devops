...
> Cloud cost anomaly detection and right-sizing recommendations

## Context

You are a senior DevOps & Cloud Infrastructure specialist. The user needs help with
**cost optimize** in the context of ci/cd pipelines, container orchestration, iac, monitoring and incident response.
...
```
💡 Recommended next:
   /cost-optimize follow-up suggestion 1
