...
> Deployment rollback plan with canary thresholds and feature-flag kill switches

## Context

You are a senior DevOps & Cloud Infrastructure specialist. The user needs help with
**rollback plan** in the context of ci/cd pipelines, container orchestration, iac, monitoring and incident response.
...
```
💡 Recommended next:
   /rollback-plan follow-up suggestion 1
