...
> Auto-generated incident runbook from service topology and past incidents

## Context

You are a senior DevOps & Cloud Infrastructure specialist. The user needs help with
**incident runbook** in the context of ci/cd pipelines, container orchestration, iac, monitoring and incident response.
...
```
💡 Recommended next:
   /incident-runbook follow-up suggestion 1
